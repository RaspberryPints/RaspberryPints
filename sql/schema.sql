...
( 'showSrmImg', '1', 'Show SRM Image', '1', NOW(), NOW() ),
...
( 'version', '3.0.0.0', 'Version', '0', NOW(), NOW() ),
...
INSERT INTO `kegTypes` ( displayName, maxAmount, emptyWeight, createdDate, modifiedDate ) VALUES
( 'Ball Lock (5 gal)', '5', '8.1571', NOW(), NOW() ),
( 'Ball Lock (2.5 gal)', '2.5', '4.0786', NOW(), NOW() ),
( 'Ball Lock (3 gal)', '3', '4.8943', NOW(), NOW() ),
( 'Ball Lock (10 gal)', '10', '16.3142', NOW(), NOW() ),
( 'Pin Lock (5 gal)', '5', '8.1571', NOW(), NOW() ),
( 'Sanke (1/6 bbl)', '5.16', '9.9', NOW(), NOW() ),
( 'Sanke (1/4 bbl)', '7.75', '14.85', NOW(), NOW() ),
( 'Sanke (slim 1/4 bbl)', '7.75', '14.85', NOW(), NOW() ),
( 'Sanke (1/2 bbl)', '15.5', '29.7', NOW(), NOW() ),
( 'Sanke (Euro)', '13.2', '0', NOW(), NOW() ),
( 'Cask (pin)', '10.81', '0', NOW(), NOW() ),
( 'Cask (firkin)', '10.81', '0', NOW(), NOW() ),
( 'Cask (kilderkin)', '21.62', '0', NOW(), NOW() ),
( 'Cask (barrel)', '43.23', '0', NOW(), NOW() ),
( 'Cask (hogshead)', '64.85', '0', NOW(), NOW() );
