...
of the ABV container.  The renderer applies style to 4 distinct elements:
...
The 8 elements are group and each group then copied 2 times to make the 3 identical groups.
The first group has no transformation to it
The second flips horizontal and moves over to create a mirror image
The third rotates 90 degrees to create a laying down glass