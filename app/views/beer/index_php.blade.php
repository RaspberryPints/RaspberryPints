		...
		<?php }else{ ?>
			<?php foreach ($beers as $beer){ ?>
				<thead>
					<tr class="intborder">
						<th width="35%" style="vertical-align: middle;">
							<h3><?php echo $beer->name ?></h3>
						</th>
						<th width="35%" style="vertical-align: middle;">
							<b><?php echo $beer->BeerStyle->name ?></b>
							<br>
							BJCP <?php echo $beer->BeerStyle->catNum ?> - <?php echo $beer->BeerStyle->category ?>
						</th>
				...
				<tbody>
					<tr class="intborder">
						<td colspan="4">
							<?php if (isset($beer->notes) ) { ?>
								<blockquote><?php echo $beer->notes ?></blockquote>
							<?php } ?>
						</td>
					</tr>
					<tr class="intborder thick">
						<td>
							<p><b><u>Vitals</u></b></p>
							<p>
								<b>SRM:</b> <?php echo isset($beer->srmEst) ? $beer->srmEst : 'N/A' ?>
								<br/>
								<b>IBU:</b> <?php echo isset($beer->ibuEst) ? $beer->ibuEst : 'N/A' ?>
								<br/>
								<b>IBU:</b> <?php echo isset($beer->ogEst) ? $beer->ogEst : 'N/A' ?>
								<br/>
								<b>IBU:</b> <?php echo isset($beer->fgEst) ? $beer->fgEst : 'N/A' ?>
							</p>
