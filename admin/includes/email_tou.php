...
<title>KegerFace-USER Reset</title>
...
<body>
	<div id="logincontainer">
    	<div id="loginbox">
        	<div id="loginheader">
            	<a href="../" style="text-decoration:none;"><h1><font color="#00CCFF">KegerFace Login</h1></font></a>
            </div>
            <div id="innerlogin">
            	<form name="email_tou" action="send_username_ac.php" method="post">
                <p>Enter your Email:</p>
                	<input type="text" class="logininput" name="email_tou" id="email_tou" />
