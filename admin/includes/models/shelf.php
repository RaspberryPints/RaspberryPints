...
{  
	...
	public function get_bottleId(){ return $this->_kegId; }
	public function set_bottleId($_kegId){ $this->_kegId = $_kegId; }

	public function get_shelfNumber(){ return $this->_tapNumber; }
	public function set_shelfNumber($_tapNumber){ $this->_tapNumber = $_tapNumber; }
	...
	{  	
		...
		if( isset($postArr['bottleId']) )
			$this->set_bottleId($postArr['bottleId']);
		else
			$this->set_bottleId(null);
			
		if( isset($postArr['shelfNumber']) )
			$this->set_shelfNumber($postArr['shelfNumber']);
		else
			$this->set_shelfNumber(null);
