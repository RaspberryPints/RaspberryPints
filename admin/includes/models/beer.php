...
{  
    ...
    public function get_recipe(){ return $this->_recipe; }
	public function set_recipe($_recipe){ $this->_recipe = $_recipe; }
	...
	{  
		...
		if( isset($postArr['ibuAct']) )
    		...
    		if( isset($postArr['recipe']) )
			$this->set_recipe($postArr['recipe']);
		else
