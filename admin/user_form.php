...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if($redirect) redirect('user_list.php');
}
if( isset($_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_REFERER'] != '' )$_SESSION['HTTP_REFERER'] = $_SERVER['HTTP_REFERER'];
if( isset($_GET['id'])){
...
?>
	...
	<div id="rightside">
		<div class="contentcontainer med left">
			...
			<p>Fields marked with <b><font color="red">*</font></b> are required.</p><br><br>
            ...
            <form id="user-form" method="POST">
                ...
                <table width="800" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td> 
							<?php if(!$user->get_id()){ ?>
                            	<input type="text" id="username" class="largebox" name="username" value="<?php echo $user->get_username() ?>" />
							<?php }else{ ?>
					...
					<?php if(!$user->get_id() || isset($_GET['changeToken']) || $user->get_active() == 0){ ?>
                        ...
                        <tr>
                            <td width="100">
                                <b>Password:<font color="red">*</font></b>
                            </td>
                            <td> 
                                <input type="password" id="password" class="largebox" name="password" value="<?php if(!isset($_GET['changeToken']) &&  $user->get_active() != 0)echo $user->get_password() ?>" />
                            </td>
                        </tr>
                        <tr>
                            <td width="100">
                                <b>Confirm Password:<font color="red">*</font></b>
                            </td>
                            <td> 
                                <input type="password" id="password1" class="largebox" name="password1" value="" />
					...
					<?php if(!isset($_GET['changeToken'])){ ?>
                        <tr>
                            ...
                            <td>
                                <input type="text" id="nameFirst" class="largebox" name="nameFirst" value="<?php echo $user->get_nameFirst() ?>" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" id="nameLast" class="largebox" name="nameLast" value="<?php echo $user->get_nameLast() ?>" />					
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" id="email" class="largebox" name="email" value="<?php echo $user->get_email() ?>" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <b>UnTapped Access Token:</b>
                            </td>
                            <td>
                                <input type="text" id="unTapAccessToken" class="largebox" name="unTapAccessToken" value="<?php echo $user->get_unTapAccessToken() ?>" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" id="mugId" class="smallbox" name="mugId" value="<?php echo $user->get_mugId() ?>" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="checkbox" id="isAdmin" class="xsmallbox" name="isAdmin" value="1" <?php if($user->get_isAdmin() != 0)echo "checked" ?>  />
                            </td>
                        </tr>
                    <?php } ?>
                    <tr>
                        <td colspan="2">
                            ...
                            <input type="button" class="btn" value="Cancel" onClick="window.location='user_list.php'" />
                        </td>
                    </tr>
                 </table>
                <br />
            ...
            <h1>RFID</h1>
            <table width="500" border="0" cellspacing="0" cellpadding="0" class="outerborder">
            	<tr>
                	<th>RFID Tag</th>
                    <th>Description</th>
                    <th></th>
